...
CTFrontendBuilder.controller("ControllerNavigation",["$scope","$parentScope","$http","$timeout",function(T,c,e,s){T.openFolders={},T.toggledNodes=[],T.generateBreadcrumbs=function(e,t){return!1},T.calcDefaultComponentTitle=function(e,t){var o=T.niceNames[e.name];return"ct_reusable"==e.name?o+=" (post: "+e.options.view_id+")":"ct_woocommerce"==e.name&&(hookName=T.getWooCommerceHookNiceName(e.options.original.hook_name),o+=hookName),t||(o+=" (#"+e.id+")"),o},T.setComponentCategory=function(e,t,o){var n=T.findComponentItem(T.componentsTree.children,e,T.getComponentItem);n.options.ct_category===t?(delete n.options.ct_category,delete T.component.options[e].ct_category):(n.options.ct_category=t,T.component.options[e].ct_category=t),jQuery(o.target).closest(".ct-more-options-expanded").removeClass("ct-more-options-expanded")},T.generateDOMTreeNavigator=function(e,w,N,t,k){null==T.component.options[99999]&&(T.component.options[99999]=[]),T.component.options[99999].nicename="Button Area",void 0===t&&(t=!1);var I=!1;angular.forEach(e.children,function(e,t){if(!I){if(void 0===w||e.id==w){var o=e.id,n=e.name,a="",r="",i=" ng-class=\"{'ct-dom-tree-node-expanded' : toggledNodes["+o+"],'ct-dom-tree-child' : hasParent("+o+')}"}',c=" ng-class=\"{'ct-dom-tree-node-selected' : parentScope.isActiveId("+o+')}"',s="";"oxy_header_left"==n||"oxy_header_center"==n||"oxy_header_right"==n?(activateID=e.options.ct_parent,activateName="oxy_header_row",a+=" dom-tree-disabled"):(activateID=o,activateName=n);var l=T.calcDefaultComponentTitle(e),d=' ng-mousedown="parentScope.triggerCodeMirrorBlur('+o+');" ng-click="activateComponent('+activateID+", '"+activateName+"',$event); parentScope.scrollToComponent('"+e.options.selector+"');\"";if(99999==e.id&&(d=""),"true"!=CtBuilderAjax.userEditOnly||T.isElementEnabledForUser(e.name)||"ct_code_block"!==e.name||(d="",a+=" ct-dom-tree-node-disabled"),e.children||(a+=" ct-dom-tree-no-children"),"ct_columns"!=e.name&&"ct_new_columns"!=e.name&&"ct_column"!=e.name&&"ct_section"!=e.name&&"ct_ul"!=e.name&&"ct_link"!=e.name&&("ct_inner_content"!=e.name||CtBuilderAjax.query&&CtBuilderAjax.query.post_type&&"ct_template"===CtBuilderAjax.query.post_type)&&"ct_div_block"!=e.name&&"oxy_dynamic_list"!=e.name&&"ct_nestable_shortcode"!=e.name&&"oxy_icon_box_button_area"!=e.name&&"oxy_tabs"!=e.name&&"oxy_tabs_contents"!=e.name&&"oxy_tab"!=e.name&&"oxy_tab_content"!=e.name&&"oxy_toggle"!=e.name&&"oxy_header"!=e.name&&"ct_if_wrap"!=e.name&&"ct_else_wrap"!=e.name&&"oxy_header"!=e.name&&"oxy_header_left"!=e.name&&"oxy_header_center"!=e.name&&"oxy_header_right"!=e.name&&"ct_slider"!=e.name&&"ct_slide"!=e.name&&"ct_modal"!=e.name||(a+=" ct-accept-drops"),T.isAPIComponent(e.name)&&T.componentsTemplates[n].nestable&&(a+=" ct-accept-drops"),s+=" data-component-name='"+e.name+"' ","ct_columns"==e.name&&(a+=" ct-sortable-columns"),"ct_column"==e.name&&(a+=" ct-sortable-column"),"ct_ul"==e.name&&(a+=" ct-sortable-ul"),"ct_li"==e.name&&(a+=" ct-sortable-li"),"ct_if_wrap"==e.name&&(a+=" ct-sortable-if-wrap"),"oxy_dynamic_list"==e.name&&(a+=" ct-sortable-dynamic-list"),"ct_else_wrap"==e.name&&(a+=" ct-sortable-else-wrap"),"ct_slider"==e.name&&(a+=" ct-sortable-slider"),"ct_modal"==e.name&&(a+=" ct-sortable-modal"),"ct_slide"==e.name&&(a+=" ct-sortable-slide"),"ct_section"==e.name&&(a+=" ct-sortable-section"),"ct_link"==e.name&&(a+=" ct-sortable-link"),"ct_link_text"==e.name&&(a+=" ct-sortable-link-text"),"ct_new_columns"==e.name&&(a+=" ct-sortable-new-columns"),"ct_div_block"==e.name&&(a+=" ct-sortable-div-block"),"oxy_header"==e.name&&(a+=" ct-sortable-header"),"oxy_header_row"==e.name&&(a+=" ct-sortable-header-row"),"oxy_tabs"==e.name&&(a+=" ct-sortable-tabs"),"oxy_tabs_contents"==e.name&&(a+=" ct-sortable-tabs-contents"),"oxy_tab"==e.name&&(a+=" ct-sortable-tab"),"oxy_tab_content"==e.name&&(a+=" ct-sortable-tab-content"),"ct_span"!=e.name&&"oxy_header_left"!=e.name&&"oxy_header_right"!=e.name&&"oxy_header_center"!=e.name&&"true"!=e.options.oxy_builtin&&(a+=" ct-draggable"),"ct_span"!=e.name&&"true"!=e.options.oxy_builtin)var m='<li ng-show="isCanComponentize('+o+",'"+n+'\');"ng-click="saveReusable('+o+')">Make Re-Usable</li>',p='<li ng-click="duplicateComponent('+o+",'"+n+"',"+e.options.ct_parent+')">Duplicate</li>',g="<li ng-click=\"wrapComponentWith('ct_div_block',"+o+","+e.options.ct_parent+')">Wrap with &#60;div&#62;</li>';else m="",p="",g="";var u="";if(!angular.element("body").hasClass("ct_connection_active")||"ct_section"!=e.name&&"ct_div_block"!=e.name||(u='<li ng-click="saveReusable('+o+', true)">Copy to Block</li>'),null==T.component.options[e.id]&&(T.component.options[e.id]={}),T.component.options[e.id].nicename=T.component.options[e.id].nicename&&""!==T.component.options[e.id].nicename.trim()?T.component.options[e.id].nicename:l,T.component.options[e.id].ct_parent=e.options.ct_parent,parseInt(e.id)<1e5){if("oxy_header_left"!=e.name&&"oxy_header_right"!=e.name&&"oxy_header_center"!=e.name&&"ct_if_wrap"!=e.name&&"ct_else_wrap"!=e.name)var v='<img src="'+CtBuilderAjax.oxyFrameworkURI+'/toolbar/UI/oxygen-icons/structure-pane/delete.svg" class="" title="Remove Component" ng-click="removeComponentWithUndo('+o+",'"+n+"',"+e.options.ct_parent+')"/>';else v="";"true"!=CtBuilderAjax.userEditOnly||T.isElementEnabledForUser(e.name)||(v="");var _=!1;if(CtBuilderAjax.componentCategories&&0<CtBuilderAjax.componentCategories.length)for(key in _="",CtBuilderAjax.componentCategories)_+="<li ng-class=\"{'active': component.options[component.active.id]['ct_category'] === '"+CtBuilderAjax.componentCategories[key]+'\'}" ng-click="showCategorize=false; setComponentCategory('+e.id+", '"+CtBuilderAjax.componentCategories[key]+"', $event)\">"+CtBuilderAjax.componentCategories[key]+"</li>";var y="<span ng-show=\"getOption('conditionspreview',"+o+")!=='0'\" ng-click=\"setOptionModel('conditionspreview', '0', "+o+",'"+n+"'); parentScope.evalGlobalConditions("+o+'); parentScope.evalGlobalConditionsInList()" class="ct-always-hide-icon"><img src="'+CtBuilderAjax.oxyFrameworkURI+'/toolbar/UI/oxygen-icons/structure-pane/visible.svg" title="Always Hide"/></span>',b="<span ng-show=\"getOption('conditionspreview',"+o+")==='0'\" ng-click=\"setOptionModel('conditionspreview', '2', "+o+",'"+n+"'); parentScope.evalGlobalConditions("+o+'); parentScope.evalGlobalConditionsInList()" class="ct-always-show-icon"><img src="'+CtBuilderAjax.oxyFrameworkURI+'/toolbar/UI/oxygen-icons/structure-pane/visible.svg" title="Always Show"/></span>',h=angular.element("body").hasClass("ct_connection_active")&&_&&(0===parseInt(e.options.ct_parent)||1e5<parseInt(e.options.ct_parent));99999!=e.id&&"true"!=e.options.oxy_builtin&&(r='<div class="ct-node-options">'+y+b+'<img src="'+CtBuilderAjax.oxyFrameworkURI+'/toolbar/UI/oxygen-icons/structure-pane/edit.svg" class="ct-more-options-icon" ng-click="showCategorize=false"/>'+v+'<div class="ct-more-options-container"><div class="ct-more-options"><ul ng-show="showCategorize!=true">'+m+u+p+g+'<li ng-click="setEditableFriendlyName('+o+')">Rename</li>'+(h?'<li ng-click="showCategorize=true">Categorize</li>':"")+"</ul>"+(h?'<ul ng-show="showCategorize==true"><li ng-click="showCategorize=false">< Back</li>'+_+"</ul>":"")+"</div></div></div>",r+='<div class="ct-node-options-none-hovered"><span class="ct-always-show-icon" ng-show="getOption(\'conditionspreview\','+o+")==='0'\"><img src=\""+CtBuilderAjax.oxyFrameworkURI+'/toolbar/UI/oxygen-icons/structure-pane/visible.svg" title="Always Show"/></span></div>'),N.HTML+='<div ng-attr-tree-actual-id="'+e.actualID+'" ng-attr-tree-id="'+e.id+'"'+i+' id="ct-dom-tree-node-'+e.id+'" class="ct-dom-tree-node '+a+'" '+s+' ng-Style="parentScope.isActiveId('+o+')?{zIndex: 9999}:{}"><div class="ct-dom-tree-bottom-dash-cover"></div><div class="ct-dom-tree-left-dash-cover"></div><div ng-attr-node-id="'+o+'" class="ct-dom-tree-node-anchor ct-dom-tree-node-type-general ct-dom-tree-name"'+c+d+'><div class="ct-dom-tree-node-header" ng-class="{\'ct-handle\': editableFriendlyName!='+o+(h?", 'categorized-component': component.options['"+e.id+"']['ct_category']":"")+'}"><div class="ct-expand-butt" ng-click="toggleNode('+o+',$event)"><span class="ct-icon"></span></div><span class="oxy-drag-handle"><img src="'+CtBuilderAjax.oxyFrameworkURI+'/toolbar/UI/oxygen-icons/drag-n-drop.svg" title=""/></span><span class="ct-icon ct-node-type-icon"></span><i class="ct-icon-if-conditions" ng-if="(component.options['+o+"]['model']['globalconditions'] && component.options["+o+"]['model']['globalconditions'].length > 0) || component.options["+o+"]['model']['conditionspreview'] === '0'\"></i><span class=\"ct-nicename\" ng-if=\"editableFriendlyName!="+o+'" ng-bind="component.options[\''+e.id+'\'][\'nicename\']" ></span><span class="ct-nicename ct-nicename-editing" ng-blur="setEditableFriendlyName(0)" ng-change="updateFriendlyName('+o+')" ng-if="editableFriendlyName=='+o+'" contenteditable="true" data-plaintext="true" data-defaulttext="'+l+'" ng-Model="component.options[\''+e.id+"']['nicename']\" focus-me=\"true\" ></span>"+r+'</div><div class="ct-dom-tree-horizontal-dash"></div></div>'}if(e.children){if("oxy_icon_box"==e.name&&parseInt(e.id)<1e5){console.log(e.id),e=angular.copy(e);var C=angular.copy(e);C.name="oxy_icon_box_button_area",C.actualID=C.id,C.id=99999,C.children.splice(0,1),e.children.splice(1,0,C),e.children.length=2}T.generateDOMTreeNavigator(e,void 0,N,!0)}parseInt(e.id)<1e5&&(N.HTML+="</div>"),void 0===w&&(T.componentsTreeNavigator=N.HTML),T.findComponentItem(T.componentsTree.children,e.id,T.loadComponentNiceName)}else e.children&&T.generateDOMTreeNavigator(e,w,N);if(e.id==w){I=!0,T.removeDOMTreeNavigatorNode(e.id);var f=e.options.ct_parent<1e5?e.options.ct_parent:0;0===f&&T.innerContentRoot&&T.innerContentRoot.id&&(f=T.innerContentRoot.id);var x=window.parent.document.getElementById("ct-dom-tree-node-"+f);x=angular.element(x),T.cleanInsert(N.HTML,x,t+3,k),jQuery(x).removeClass("ct-dom-tree-no-children")}}})},T.updateDOMTreeNavigator=function(e,t){var o=window.parent.document.getElementById("ct-dom-tree");if(!o)return!1;c.showSidePanel,T.log&&console.log("updateDOMTreeNavigator()",e),T.functionStart("updateDOMTreeNavigator");var n={HTML:""},a=0;T.innerContentRoot&&T.innerContentRoot.id&&(a=T.innerContentRoot.id);var r='<div id="ct-dom-tree-node-'+a+'" ng-attr-tree-id="'+a+'" dragula="\'ct-dom-tree\'" class="oxy-dom-tree-root ct-accept-drops ct-elements-managers-bottom"><span></span><span></span><div  ng-mousedown="triggerCodeMirrorBlur(0);" ng-click="activateComponent(0, \'root\')" ng-class="{\'ct-dom-tree-node-selected\' : parentScope.isActiveId(0)}" ng-attr-tree-id="'+a+'" ng-click="activateComponent(0, \'root\')" class="ct-dom-tree-body-anchor ct-dom-tree-node-anchor ct-dom-tree-parent"><span class="ct-icon ct-dom-parent-icon"></span>'+(window.parent.document.getElementsByTagName("BODY")[0].classList.contains("ct_inner")?"Inner Content":"Body")+"</div>";void 0===e&&(o=angular.element(o)).empty(),T.functionStart("generateDOMTreeNavigator"),t||T.generateDOMTreeNavigator(T.componentsTree,e,n,!1),T.functionEnd("generateDOMTreeNavigator"),r+=n.HTML+"</div></div>",void 0===e&&T.cleanInsert(r,o),T.functionEnd("updateDOMTreeNavigator")},T.removeDOMTreeNavigatorNode=function(e){T.log&&console.log("try removeDOMTreeNavigatorNode()",e);var t=window.parent.document.getElementById("ct-dom-tree-node-"+e);t=angular.element(t);var o=jQuery(t).parent();0<t.length&&T.log&&console.log("DOMTreeNavigatorNode() removed",e,t),t.remove(),void 0!==t.scope()&&t.scope().$destroy(),t=null,jQuery(o).children().length<=3&&jQuery(o).addClass("ct-dom-tree-no-children")},T.toggleNode=function(e,t){if(void 0!==t&&(angular.element("#ct-sidepanel").trigger(t.type),t.stopPropagation()),T.latestDroppedDOMParent!=e){var o=angular.element("div[ng-attr-tree-id="+e+"]",window.parent.document);void 0===T.toggledNodes[e]&&o.hasClass("ct-dom-tree-node-expanded")?(T.toggledNodes[e]=!1,angular.element("div[ng-attr-tree-id="+e+"]",window.parent.document).removeClass("ct-dom-tree-node-expanded")):T.toggledNodes[e]=!T.toggledNodes[e]}else T.latestDroppedDOMParent=null},T.expandAllNodes=function(){for(var e in T.component.options)T.component.options.hasOwnProperty(e)&&(T.toggledNodes[e]=!0)},T.collapseAllNodes=function(){T.toggledNodes=[]},T.highlightDOMNode=function(r,e){if(T.log&&console.log("highlightDOMNode()",r),!(1e5<r)){if(!c.isShowTab("sidePanel","DOMTree")||!c.showSidePanel)return!1;e&&e.stopPropagation(),jQuery("#ct-dom-tree-node-"+r,window.parent.document).parents(".ct-dom-tree-node:not(.ct-dom-tree-node-expanded)").each(function(){var e=jQuery(this).attr("ng-attr-tree-id");T.toggledNodes[e]=!0});var i=s(function(){var e=0;T.innerContentRoot&&T.innerContentRoot.id&&(e=T.innerContentRoot.id);var t=jQuery("#ct-dom-tree-node-"+e,window.parent.document),o=t.scrollTop(),n=jQuery("#ct-dom-tree-node-"+r,window.parent.document);if(n.offset()){t.scrollTop(0);var a=n.offset().top;t.scrollTop(o),t.stop().animate({scrollTop:a-t.offset().top-120},500),s.cancel(i)}},500,!1)}},T.openLoadFolder=function(e,t,o,n){T.experimental_components[t].fresh?(o&&angular.element(n.target).addClass("oxygen-small-progress"),T.getComponentsListFromSource(e,t,function(e){o&&(c.tabs.components=[],angular.element(n.target).removeClass("oxygen-small-progress")),T.openFolder(e,t),c.applyMenuAim()})):(o&&(c.tabs.components=[]),T.openFolder(e,t))},T.openFolder=function(e,t){T.closeAllFolders(),T.openFolders[e]=void 0===t||t,"categories-categories"===e&&(void 0!==T.libraryCategories&&null!==T.libraryCategories||(T.libraryCategories={},T.libraryPages={},T.getStuffFromSource(T.processLibraryStuff)));s(function(){jQuery(".oxygen-folder-"+e+" .ct-add-item-button-image",window.parent.document).each(function(){jQuery(this).attr("src",jQuery(this).data("src"))})},0,!1);c.applyMenuAim()},T.processLibraryStuff=function(e){var t=(e=JSON.parse(e)).items,o=(e.key,parseInt(e.next));if(t){var n=t.components;n&&_.each(n,function(e){var t=e.category;void 0===t&&(t="Other"),T.libraryCategories[t]=T.libraryCategories[t]||{},T.libraryCategories[t].slug=btoa(t).replace(/=/g,""),T.libraryCategories[t].contents=T.libraryCategories[t].contents||[],T.libraryCategories[t].contents.push(e)});var a=t.pages;a&&_.each(a,function(e){if("ct_template"!==e.type){var t=e.category;void 0===t&&(t="Other"),T.libraryPages[t]=T.libraryPages[t]||{},T.libraryPages[t].slug=btoa(t).replace(/=/g,""),T.libraryPages[t].contents=T.libraryPages[t].contents||[],T.libraryPages[t].contents.push(e)}})}T.getStuffFromSource(T.processLibraryStuff,o),c.applyMenuAim()},T.closeAllFolders=function(e){T.openFolders={}},T.isShowFolder=function(e){return!!T.openFolders[e]},T.hasOpenFolders=function(){return 0<Object.keys(T.openFolders).length}}]);
...
CTFrontendBuilder.controller("ControllerAJAX",["$scope","$parentScope","$http","$timeout",function(h,g,f,x){h.postsData=[],h.showErrorModal=function(e,o,t,r){var n="";n=e&&0<e?("string"==typeof o?"<h4>"+o+"</h4>":"")+"<p><strong>"+("string"==typeof t?t:"")+" "+e+"</strong></p><p>Your server returned a "+e+" error for the request to "+r+".</p><p><a href='http://oxygenbuilder.com/documentation/troubleshooting/troubleshooting-guide/' style='text-decoration: underline; color: #fff;' target='_blank'>Troubleshooting Guide &raquo;</a></p>":("string"==typeof o?"<h4>"+o+"</h4>":"")+"<p><strong>"+("string"==typeof t?t:"")+"</strong></p>",h.showNoticeModal("<div>"+n+"</div>")},h.savePage=function(a){a||g.showLoadingOverlay("savePage()"),g.disableContentEdit();var e={classes:h.classes,custom_selectors:h.customSelectors,style_sets:h.styleSets,style_folders:h.styleFolders,style_sheets:h.styleSheets,page_settings:h.pageSettingsMeta,global_settings:h.globalSettings,easy_posts_templates:h.easyPostsCustomTemplates,comments_list_templates:h.commentsListCustomTemplates,typekit_fonts:h.typeKitFonts,global_colors:h.globalColorSets,element_presets:h.elementPresets,preview:(h.previewType,h.template.postData.permalink),codemirror_theme:h.globalCodeMirrorTheme,codemirror_wrap:h.globalCodeMirrorWrap};h.googleFontsCache||(e.google_fonts_cache=h.googleFontsList),angular.forEach(h.activeSelectors,function(e,o){h.skipChanges=!0,h.findComponentItem(h.componentsTree.children,o,h.updateComponentActiveSelector,e)}),h.watchIntervalCallback(),h.skipChanges=!1;var o={params:e,tree:h.componentsTree};o=angular.toJson(o),e={action:"ct_save_components_tree",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};(jQuery("body").hasClass("ct_inner")||jQuery("body",window.parent.document).hasClass("ct_inner"))&&(e.ct_inner=!0),f({url:h.getAJAXRequestURL(),method:"POST",params:e,data:o,transformResponse:!1}).success(function(o,t,e,r){try{var n;if(a)0!=(n=JSON.parse(o)).post_saved&&h.allSaved();else 0===(n=JSON.parse(o))?h.showErrorModal(0,"YOUR PAGE WAS NOT SAVED BECAUSE YOU ARE NOT LOGGED IN. Open a new browser tab and log back in to WordPress. Then attempt to save the page again."):0==n.post_saved?(console.log(o),h.showErrorModal(0,"Error occurred while saving. Please contact support.")):h.allSaved(),g.hideLoadingOverlay("savePage()")}catch(e){console.log(o),console.log(e),a||h.showErrorModal(t,"Error occurred while saving",e)}}).error(function(e,o,t,r){console.log(e,o),a||g.hideLoadingOverlay("savePage()")}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while saving",e.statusText,e.config.url)})},h.updateComponentActiveSelector=function(e,o,t){o&&o.options&&(o.options.activeselector=t)},h.saveComponentAsView=function(a,e,s){var o={action:"ct_save_component_as_view",name:h.componentizeOptions.name,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,block:s},i=s?"Block":"Re-usable part";if(e.constructor===Array)var t=e;else t=[e];f({url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:o,data:{id:0,name:"root",depth:0,children:t}}).success(function(e,o,t,r){if(g.hideLoadingOverlay("saveComponentAsView()"),0!=e){var n=s?"Manage Blocks in the WordPress admin at Oxygen &gt; Block Library.":"";h.showNoticeModal("<div>"+i+" '"+h.componentizeOptions.name+"' created. "+n+"</div>","ct-notice"),s||h.replaceReusablePart(a,e)}else h.showErrorModal(0,'Error occurred while saving "'+i+'".')}).error(function(e,o,t,r){console.log(e,o),g.hideLoadingOverlay("saveComponentAsView()")}).then(null,function(e){h.showErrorModal(e.status,'Error occurred while saving "'+i+'".',e.statusText,e.config.url)})},h.loadComponentsTree=function(s,i,l,c){h.log&&console.log("loadComponentsTree()",i,l,c),g.showLoadingOverlay("loadComponentsTree()"),void 0===i&&(i=CtBuilderAjax.postId);var e={action:"ct_get_components_tree",id:i,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};jQuery("body").hasClass("ct_inner")&&(e.ct_inner=!0),f({url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,r){try{var n=JSON.parse(o);if(s(n,i,l,c),n.notRegisteredShortcodes){var a=Object.values(n.notRegisteredShortcodes);h.showErrorModal(0,"Shortcodes present in design but not registered in WordPress: <br/>"+a.join(", ")+". <br/><br/>Saving now will result in this design breaking. Please re-activate the plugins that supply the shortcodes listed above before saving this design.")}}catch(e){console.log(o,e),h.showErrorModal(0,"Error occurred while loading post: "+i,e)}g.hideLoadingOverlay("loadComponentsTree()")}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while loading post: "+i,e.statusText,e.config.url)})},h.renderInnerContent=function(s,e){var o=CtBuilderAjax.permalink,t={};o="term"===h.previewType?(t.term=h.template.postData.term,h.template.postData&&h.template.postData.permalink?h.template.postData.permalink:CtBuilderAjax.ajaxUrl):(t.post=h.template.postData,h.template.postData&&h.template.postData.permalink?t.post.permalink:CtBuilderAjax.ajaxUrl);var r={action:"ct_render_innercontent",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:h.stripURLProtocol(o),method:"POST",params:r,transformResponse:!1}).success(function(e,o,t,r){if(0!==parseInt(e)){var n=h.getComponentById(s);n.html();var a=angular.element("<div>");a.html(e),n.append(a),h.adjustResizeBox()}}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while rendering innercontent",e.statusText,e.config.url)})},h.evalCondition=function(n){var e;if(void 0===n&&(n=h.component.active.id),0<(e=h.getComponentById(n).closest(".oxy-dynamic-list")).length){var o=e.attr("ng-attr-component-id");h.dynamicListAction(o,n)}else if(h.component.options[n].original&&h.component.options[n].original.conditions&&0<h.component.options[n].original.conditions.length){var t=CtBuilderAjax.permalink,r={};t="term"===h.previewType?(r.term=h.template.postData.term,h.template.postData&&h.template.postData.permalink?h.template.postData.permalink:CtBuilderAjax.permalink):(r.post=h.template.postData,h.template.postData&&h.template.postData.permalink?r.post.permalink:CtBuilderAjax.permalink);var a={action:"ct_eval_condition",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:h.stripURLProtocol(t),method:"POST",params:a,data:JSON.stringify(h.component.options[n]),transformResponse:!1}).success(function(e,o,t,r){void 0!==(e=JSON.parse(e)).result&&h.setOptionModel("conditionsresult",e.result,n,h.component.options[n].name)}).error(function(e,o,t,r){console.log(e,o),h.adjustResizeBox()}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while evaluation condition",e.statusText,e.config.url)})}else delete iframeScope.component.options[n].model.conditionsresult},h.renderCustomAttributeDynamicData=function(a,s,i){var e=CtBuilderAjax.permalink;h.template.postData&&h.template.postData.permalink&&(e=h.template.postData.permalink);var l=s.match(/\[oxygen[^\]]*\]/gi),c=i.match(/\[oxygen[^\]]*\]/gi),o={action:"oxy_render_attribute_dyanmic_data",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};if(l)var t=s;else t=i;f({url:h.stripURLProtocol(e),method:"POST",params:o,data:t,transformResponse:!1}).success(function(e,o,t,r){(l&&c&&h.renderCustomAttributeDynamicData(a,e,i),l&&!c)&&((n=h.getComponentById(a)).attr&&(RegExp("[^a-z-_]+","gi").test(e)?h.showNoticeModal("<div>"+h.component.options[a].nicename+" Custom Attribute rendered data '"+e+"' is not a valid attribute <b>name</b></div>"):n.attr(e,i),console.log(e,i)));if(!l&&c){var n;if(RegExp("[^a-z-_]+","gi").test(s))return void h.showNoticeModal("<div>"+h.component.options[a].nicename+" Custom Attribute rendered data '"+s+"' is not a valid attribute <b>name</b></div>");(n=h.getComponentById(a)).attr&&(n.attr(s,h.replaceSpecialChars(e)),console.log(s,e))}}).error(function(e,o,t,r){console.log(e,o)})},h.renderShortcode=function(d,e,p,u){if(h.component.options[d]&&h.component.options[d].original&&"true"==h.component.options[d].original.dont_render){h.getComponentById(d).html("")}else{var m=CtBuilderAjax.permalink,o={};m="term"===h.previewType?(o.term=h.template.postData.term,h.template.postData&&h.template.postData.permalink?h.template.postData.permalink:CtBuilderAjax.permalink):(o.post=h.template.postData,h.template.postData&&h.template.postData.permalink?o.post.permalink:CtBuilderAjax.permalink);var g,y={action:"ct_render_shortcode",shortcode_name:e,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce},t=h.getComponentById(d),r=!1,n=[];if(t)for(var a=t.parent().closest(".oxy-dynamic-list");a&&0<a.length;)r=parseInt(a.attr("ng-attr-component-id")),h.component.options[r].original.use_acf_repeater?(a=a.parent().closest(".oxy-dynamic-list"),n.push(h.component.options[r].original.acf_repeater)):(r=parseInt(a.attr("ng-attr-component-id")),a=!1);if(r&&u){var s=h.component.options[r];u.queryOptions={query_args:s.original.query_args,wp_query:h.component.options[r].original.use_acf_repeater?"default":s.original.wp_query,query_post_ids:s.original.query_post_ids,query_post_types:s.original.query_post_types,query_taxonomies_any:s.original.query_taxonomies_any,query_taxonomies_all:s.original.query_taxonomies_all,query_authors:s.original.query_authors,query_order:s.original.query_order,query_order_by:s.original.query_order_by,query_all_posts:s.original.query_all_posts,query_ignore_sticky_posts:s.original.query_ignore_sticky_posts,query_count:s.original.query_count,wp_query_advanced:s.original.wp_query_advanced},g=JSON.stringify(u.queryOptions),0<n.length&&(u.acfRepeaterFields=n.reverse(),g+=JSON.stringify(u.acfRepeaterFields))}if(p&&(h.oxygenShortcodesCache=h.oxygenShortcodesCache||[],u&&u.original&&u.original.full_shortcode&&-1<u.original.full_shortcode.indexOf("[oxygen"))){var i=_.findWhere(h.oxygenShortcodesCache,{id:y.post_id,url:m,full_shortcode:u.original.full_shortcode,queryOptions:g});if(i)return void p(u.original.full_shortcode,i.result)}f({url:h.stripURLProtocol(m),method:"POST",params:y,data:u?JSON.stringify(u):JSON.stringify(h.component.options[d]),transformResponse:!1}).success(function(e,o,t,r){if(e||""===e){var n=h.getComponentById(d),a=angular.element("<div>");if(a.html(e),p){h.oxygenShortcodesCache=h.oxygenShortcodesCache||[];var s=a.find("#ct-shortcode-links-scripts").html();h.oxygenShortcodesCache.push({id:y.post_id,url:m,full_shortcode:u.original.full_shortcode,queryOptions:g,result:s}),p(u.original.full_shortcode,s)}else{n.html(a.find("#ct-shortcode-links-scripts").html());var i=n.closest("body");i.find('link[data-forId="'+d+'"], script[data-forId="'+d+'"]').remove(),a.find("link, script").each(function(){i.append(angular.element(this).attr("data-forId",d))});var l=x(function(){jQuery.ready(),x.cancel(l)},1e3,!1)}var c=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(c)}else console.log(e,o),p&&p(u.original.full_shortcode,""),h.showErrorModal(0,"Error occurred while rendering shortcode");h.adjustResizeBox()}).error(function(e,o,t,r){console.log(e,o),h.adjustResizeBox()}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while rendering shortcode",e.statusText,e.config.url)})}},h.evalConditionsViaAjax=function(e,n){var o=CtBuilderAjax.permalink,t={};o="term"===h.previewType?(t.term=h.template.postData.term,h.template.postData&&h.template.postData.permalink?h.template.postData.permalink:CtBuilderAjax.permalink):(t.post=h.template.postData,h.template.postData&&h.template.postData.permalink?t.post.permalink:CtBuilderAjax.permalink);var r={action:"ct_eval_conditions",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:h.stripURLProtocol(o),method:"POST",params:r,data:JSON.stringify(e),transformResponse:!1}).success(function(e,o,t,r){e=JSON.parse(e),n&&n(e)}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while evaluating conditions",e.statusText,e.config.url)})},h.removeChromeModal=function(e){if(e.stopPropagation(),e.preventDefault(),jQuery(e.target).hasClass("ct-chrome-modal-bg")||jQuery(e.target).hasClass("ct-chrome-modal-hide")){var o={action:"ct_remove_chrome_modal",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:o,transformResponse:!1}).success(function(e,o,t,r){jQuery(".ct-chrome-modal-bg").remove()}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while dismissing the notice",e.statusText,e.config.url)})}},h.renderDataComponent=function(a,e){var o=CtBuilderAjax.permalink,t={};o="term"===h.previewType?(t.term=h.template.postData.term,h.template.postData&&h.template.postData.permalink?h.template.postData.permalink:CtBuilderAjax.ajaxUrl):(t.post=h.template.postData,h.template.postData&&h.template.postData.permalink?t.post.permalink:CtBuilderAjax.ajaxUrl);var s={action:"ct_render_data_component",component_name:e,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:h.stripURLProtocol(o),method:"POST",params:s,data:JSON.stringify(h.component.options[a]),transformResponse:!1}).success(function(e,o,t,r){if(e||""===e){var n=h.getComponentById(a);switch(s.component_name){case"ct_data_featured_image":case"ct_data_author_avatar":e=JSON.parse(e),n[0].src=e.src;break;default:n.html(e)}}else console.log(e,o),h.showErrorModal(0,"Error occurred while rendering the component")}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while rendering the component",e.statusText,e.config.url)})},h.renderWidget=function(i,l){if("true"!=h.component.options[i].original.dont_render||l){h.log&&console.log("renderWidget()",i,l);var e=JSON.stringify({options:h.component.options[i]}),o=CtBuilderAjax.ajaxUrl,t={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};l?(t.action="ct_render_widget_form",g.cleanInsertUI("<span></span>","#ct-dialog-widget-content"),g.showSidebarLoader=!0):(t.action="ct_render_widget",g.showWidgetOverlay(i),o=h.getAJAXRequestURL()),f({url:h.stripURLProtocol(o),method:"POST",params:t,data:e,transformResponse:!1}).success(function(e,o,t,r){var n=h.getComponentById(i);if(e)if(l){var a=x(function(){g.cleanInsertUI('<form id="ct-widget-form" class="open">'+e+"</form>","#ct-dialog-widget-content"),window.parent.jQuery(window.parent.document).trigger("widget-added",[jQuery("#ct-widget-form",window.parent.document)]),x.cancel(a)},0,!1);g.showSidebarLoader=!1}else{void 0!==window.google&&void 0!==window.google.maps&&"sow-google-map"==h.component.options[i].id.id_base&&delete window.google.maps,n.html(e);a=x(function(){jQuery.ready(),x.cancel(a)},1e3,!1);g.hideWidgetOverlay(i),h.adjustResizeBox()}e&&""!==n.text()||l||n.html("<div class='ct-blank-widget'>Widget Content</div>");var s=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(s)}).error(function(e,o,t,r){h.getComponentById(i).html("<div class='ct-blank-widget'>Widget Content<div>")})}else{h.getComponentById(i).html("")}},h.renderSidebar=function(s,e){var o=JSON.stringify({options:h.component.options[s]}),t={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:"ct_render_sidebar"};f({url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:t,data:o,transformResponse:!1}).success(function(e,o,t,r){var n=h.getComponentById(s);e&&n.html(e),e&&""!==n.text()||n.html("<div class='ct-blank-widget'>Sidebar Content</div>");var a=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(a)}).error(function(e,o,t,r){h.getComponentById(s).html("<div class='ct-blank-widget'>Sidebar Content<div>")})},h.renderNavMenu=function(a){void 0===a&&(a=h.component.active.id),h.log&&console.log("renderNavMenu()",a),g.showWidgetOverlay(a);var e=JSON.stringify({options:h.component.options[a]}),o=h.getAJAXRequestURL();params={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:"oxy_render_nav_menu"},f({url:h.stripURLProtocol(o),method:"POST",params:params,data:e,transformResponse:!1}).success(function(e,o,t,r){var n=h.getComponentById(a);e?n.html(e):n.html("No menu found"),h.adjustResizeBox(),g.hideWidgetOverlay(a)}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while rendering menu",e.statusText,e.config.url)})},h.getDynamicDataFromQuery=function(n,e,a,s,o,t,r){void 0===n&&(n=h.component.active.id),h.log&&console.log("getDynamicListData()",action,n);var i=CtBuilderAjax.permalink;if(CtBuilderAjax.oxyTemplate&&!CtBuilderAjax.oxyReusable){if(!h.template.postData||!h.template.postData.permalink)return void h.showErrorModal(0,"Permalink not available for the current post/archive. If it is an archive for a custom post type , make sure that the parameter 'has_archive' for the post type is set to true.");i=h.template.postData.permalink+("/"==h.template.postData.permalink.substr(h.template.postData.permalink.length-1)?"":"/")}else CtBuilderAjax.oxyReusable&&CtBuilderAjax.ctSiteUrl&&(i=CtBuilderAjax.ctSiteUrl+"/");var l={options:h.component.options[n],models:e};if(o){var c=h.component.options[o];l.queryOptions={query_args:c.original.query_args,wp_query:c.original.wp_query,query_post_ids:c.original.query_post_ids,query_post_types:c.original.query_post_types,query_taxonomies_any:c.original.query_taxonomies_any,query_taxonomies_all:c.original.query_taxonomies_all,query_authors:c.original.query_authors,query_order:c.original.query_order,query_order_by:c.original.query_order_by,query_all_posts:c.original.query_all_posts,query_ignore_sticky_posts:c.original.query_ignore_sticky_posts,query_count:c.original.query_count,wp_query_advanced:c.original.wp_query_advanced}}t&&0<t.length&&(l.acfRepeaterFields=t.reverse());l=JSON.stringify(l);var d={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:"oxy_get_dynamic_data_query"};g.showWidgetOverlay(n),f({url:h.stripURLProtocol(i),method:"POST",params:d,data:l,transformResponse:!1}).success(function(e,o,t,r){e?(e=JSON.parse(e),a&&a(e.results,s,e.pagination?e.pagination:null)):component.html("No data received"),g.hideWidgetOverlay(n)}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){h.showErrorModal(e.status,"Error occurred",e.statusText,e.config.url)})},h.renderComponentWithAJAX=function(s,i){void 0===i&&(i=h.component.active.id);var e=h.getComponentById(i);if(e){var o=e.parents(".oxy-product-builder").attr("ng-attr-component-id");h.log&&console.log("renderComponentWithAJAX()",s,i);var t=h.component.options[i];if(o){var r=h.getOption("oxy-product-builder_product_id",o);t.product_builder_id=r}var n={options:t,component:h.findComponentItem(h.componentsTree.children,i,h.getComponentItem)},a=h.getAJAXRequestURL(),l={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:s},c=h.getComponentById(i),d=!1,p=[];if(c)for(var u=c.parent().closest(".oxy-dynamic-list");u&&0<u.length;)d=parseInt(u.attr("ng-attr-component-id")),h.component.options[d].original.use_acf_repeater?(u=u.parent().closest(".oxy-dynamic-list"),p.push(h.component.options[d].original.acf_repeater)):(d=parseInt(u.attr("ng-attr-component-id")),u=!1);if(d){var m=h.component.options[d];n.queryOptions={query_args:m.original.query_args,wp_query:h.component.options[d].original.use_acf_repeater?"default":m.original.wp_query,query_post_ids:m.original.query_post_ids,query_post_types:m.original.query_post_types,query_taxonomies_any:m.original.query_taxonomies_any,query_taxonomies_all:m.original.query_taxonomies_all,query_authors:m.original.query_authors,query_order:m.original.query_order,query_order_by:m.original.query_order_by,query_all_posts:m.original.query_all_posts,query_ignore_sticky_posts:m.original.query_ignore_sticky_posts,query_count:m.original.query_count,wp_query_advanced:m.original.wp_query_advanced},0<p.length&&(n.acfRepeaterFields=p.reverse())}g.showWidgetOverlay(i),"oxy_render_easy_posts"==s&&jQuery(".oxygen-easy-posts-ajax-styles-"+i).remove(),f({url:h.stripURLProtocol(a),method:"POST",params:l,data:JSON.stringify(n),transformResponse:!1}).success(function(e,o,t,r){var n=h.getComponentById(i);if(n)if(e){n.removeClass("oxy-ajax-loading");var a=new Event("oxygen-ajax-element-loaded");document.dispatchEvent(a),n.html(e),"oxy_render_easy_posts"==s&&n.find(".oxygen-easy-posts-ajax-styles-"+i).prependTo("head"),h.outputCSSOptions()}else n.html("No data received");else h.showNoticeModal("<div>"+h.component.options[i].nicename+" loading error.</div>");h.adjustResizeBox(),g.hideWidgetOverlay(i)}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while rendering the component",e.statusText,e.config.url)})}},h.loadSVGIconSets=function(){var e={action:"ct_get_svg_icon_sets",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,r){try{var n=JSON.parse(o);h.SVGSets=n,h.currentSVGSet=Object.keys(n)[0]}catch(e){console.log(o),console.log(e),h.showErrorModal(0,"Error occurred while loading SVG icons")}}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while loading SVG icons",e.statusText,e.config.url)})},h.loadAttachmentSizes=function(e,n){var o={action:"ct_get_attachment_sizes",post_id:CtBuilderAjax.postId,attachment_id:e,nonce:CtBuilderAjax.nonce};f({url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:o,transformResponse:!1}).success(function(o,e,t,r){try{o=JSON.parse(o)}catch(e){console.log(o),console.log(e),h.showErrorModal(0,"Error occurred while loading attachment sizes")}n(o)}).error(function(e,o,t,r){console.log(e,o)}).then(null,function(e){h.showErrorModal(e.status,"Error occurred while loading attachment sizes",e.statusText,e.config.url)})},h.loadTemplateData=function(a,e,o){o||g.showLoadingOverlay("loadTemplateData()");var t={action:"ct_get_template_data",template_id:CtBuilderAjax.postId,preview_post_id:e,preview_type:h.previewType,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:t,transformResponse:!1}).success(function(o,e,t,r){try{var n=JSON.parse(o);a(n)}catch(e){console.log(o),console.log(e),h.showErrorModal(0,"Failed to load template data",e)}g.hideLoadingOverlay("loadTemplateData()")}).error(function(e,o,t,r){console.log(e,o),g.hideLoadingOverlay("loadTemplateData()")}).then(null,function(e){h.showErrorModal(e.status,"Failed to load template data",e.statusText,e.config.url)})},h.loadComponentsTemplates=function(){g.showLoadingOverlay("loadComponentsTemplates()");var e={action:"oxy_get_components_templates",nonce:CtBuilderAjax.nonce,post_id:CtBuilderAjax.postId};f({url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,r){try{var n=JSON.parse(o);h.componentsTemplates=n}catch(e){console.log(o),console.log(e),h.showErrorModal(0,"Failed to load templates",e),g.hideLoadingOverlay("loadComponentsTemplates()")}if(CtBuilderAjax.ctTemplate)h.loadTemplateData(h.setTemplateData,null,!0);else if(g.hideLoadingOverlay("loadComponentsTemplates()"),h.componentsTree.children){h.buildComponentsFromTree(h.componentsTree.children);!function e(o){o++,setTimeout(function(){0<h.buildingOxygenTreeCounter&&o<180?e(o):(h.updateDOMTreeNavigator(),h.classesCached=!1,h.outputCSSOptions(),h.component.id++),0<h.buildingOxygenTreeCounter&&180<=o&&console.log("Tree building timeout. Styles may not be fully applied and Structure panel is not updated.")},500)}(0)}else h.updateDOMTreeNavigator();h.waitOxygenTree(function(){h.$emit("oxygen_components_loaded",!0)})}).error(function(e,o,t,r){console.log(e,o),CtBuilderAjax.ctTemplate?h.loadTemplateData(h.setTemplateData,null,!0):(g.hideLoadingOverlay("loadComponentsTemplates()"),h.componentsTree.children&&(h.buildComponentsFromTree(h.componentsTree.children),h.component.id++)),h.waitOxygenTree(function(){h.$emit("oxygen_components_loaded",!1)})}).then(null,function(e){h.showErrorModal(e.status,"Failed to load templates",e.statusText,e.config.url)})},h.loadPostData=function(a,s,i){if(h.postsData[s])a(h.postsData[s],i);else{g.showLoadingOverlay("loadPostData()");var e={action:"ct_get_post_data",id:s,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,preview_post_id:h.template.postData.ID};f({url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),method:"POST",params:e,transformResponse:!1}).success(function(o,e,t,r){try{var n=JSON.parse(o);a(n,i),h.postsData[s]=n}catch(e){console.log(o),console.log(e),h.showErrorModal(0,"Failed to load post data. ID: "+s,e)}g.hideLoadingOverlay("loadPostData()")}).error(function(e,o,t,r){console.log(e,o),g.hideLoadingOverlay("loadPostData()")}).then(null,function(e){h.showErrorModal(e.status,"Failed to load post data. ID: "+s,e.statusText,e.config.url)})}},h.execCode=function(e,n,a){var o=h.getAJAXRequestURL(),t={code:h.b64EncodeUnicode(e),query:CtBuilderAjax.query};t=JSON.stringify(t),f({method:"POST",transformResponse:!1,url:h.stripURLProtocol(o),params:{action:"ct_exec_code",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce},data:t}).success(function(e,o,t,r){0===e.trim().length&&(e=""),-1<e.indexOf("<html")&&(e=jQuery("<div>").append(e).find(".ct-code-block").html()),(e=jQuery("<div>").append(e)).find("script").remove(),e=e.html(),a(e,n)}).error(function(e,o,t,r){console.log(e,o)})},h.getStuffFromSource=function(n,e){void 0===e&&setTimeout(function(){angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).addClass("oxygen-small-progress")},100);var o={action:"ct_new_style_api_call",call_type:"get_stuff_from_source",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};if(0===parseInt(e))return angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress"),!1;null!=e&&(o.next=e),f({method:"GET",transformResponse:!1,url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),params:o}).success(function(e,o,t,r){n(e)}).error(function(e,o,t,r){console.log(e,o)})},h.getComponentsListFromSource=function(i,l,c){setTimeout(function(){angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).addClass("oxygen-small-progress")},200),f({method:"GET",transformResponse:!1,url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),params:{action:"ct_new_style_api_call",call_type:"get_items_from_source",name:l,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce}}).success(function(e,o,t,r){var n=!1;if(e&&""!=e.trim()||(n=!0),n||(e=JSON.parse(e)),n||!e.components)return h.showErrorModal(0,"Items not loaded. "+(e.error?e.error:"Try again!")),void angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress");if(angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress"),delete h.experimental_components[l].fresh,h.experimental_components[l].items={},_.each(e.components,function(e){var o=e.category;o&&(h.experimental_components[l].items[o]=h.experimental_components[l].items[o]||{},h.experimental_components[l].items[o].slug=btoa(o).replace(/=/g,""),h.experimental_components[l].items[o].contents=h.experimental_components[l].items[o].contents||[],h.experimental_components[l].items[o].contents.push(e))}),CtBuilderAjax.freeVersion&&_.each(h.experimental_components[l].items,function(e,o){var t=Math.round(e.contents.length/10);t<1?t=1:4<t&&(t=4);for(var r=0;r<e.contents.length;r++)e.contents[r].firstFew=r<t?1:0}),h.experimental_components[l].pages=h.experimental_components[l].pages||[],h.experimental_components[l].templates=h.experimental_components[l].templates||[],_.each(e.pages,function(e){"ct_template"===e.type?h.experimental_components[l].templates.push(e):h.experimental_components[l].pages.push(e)}),CtBuilderAjax.freeVersion){var a=Math.round(h.experimental_components[l].pages.length/10);a<1?a=1:4<a&&(a=4);for(var s=0;s<h.experimental_components[l].pages.length;s++)h.experimental_components[l].pages[s].firstFew=s<a?1:0;(a=Math.round(h.experimental_components[l].templates.length/10))<1?a=1:4<a&&(a=4);for(s=0;s<h.experimental_components[l].templates.length;s++)h.experimental_components[l].templates[s].firstFew=s<a?1:0}c(i),angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress")}).error(function(e,o,t,r){console.log(e,o),angular.element(".oxygen-sidebar-breadcrumb",window.parent.document).removeClass("oxygen-small-progress")})},h.getPageFromSource=function(e,n,a,s){g.showLoadingOverlay("getPageFromSource()"),f({method:"GET",transformResponse:!1,url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),params:{action:"ct_new_style_api_call",nonce:CtBuilderAjax.nonce,call_type:"get_page_from_source",id:e,post_id:CtBuilderAjax.postId,source:btoa(n)}}).success(function(e,o,t,r){s(e,n,a),g.hideLoadingOverlay()}).error(function(e,o,t,r){g.hideLoadingOverlay(),console.log(e,o)})},h.getComponentFromSource=function(e,n,a,o,s){g.showLoadingOverlay("getComponentFromSource()"),f({method:"GET",transformResponse:!1,url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),params:{action:"ct_new_style_api_call",nonce:CtBuilderAjax.nonce,post_id:CtBuilderAjax.postId,call_type:"get_component_from_source",id:e,page:o,source:btoa(n)}}).success(function(e,o,t,r){g.hideLoadingOverlay(),s(e,!1,n,a)}).error(function(e,o,t,r){g.hideLoadingOverlay(),console.log(e,o)})},h.loadedControllers=[],h.loadControlsWithAJAX=function(e){if(!h.loadedControllers[e]){h.loadedControllers[e]=!0,g.showSidebarLoader=!0;var o=CtBuilderAjax.ajaxUrl,t={action:"oxy_load_controls_"+e,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({method:"POST",url:h.stripURLProtocol(o),params:t}).success(function(e,o,t,r){e&&g.compileInsertUI(e,"#oxygen-sidebar-control-panel-basic-styles",0),g.showSidebarLoader=!1}).error(function(e,o,t,r){console.log(e,o),g.showSidebarLoader=!1})}},h.loadElementsPresets=function(e){h.elementPresets={},g.showLoadingOverlay("loadElementsPresets()");var o=CtBuilderAjax.ajaxUrl,t={action:"oxy_load_elements_presets",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({method:"POST",url:o,params:t}).success(function(e,o,t,r){e?h.elementPresets=e:console.log("No default presets loaded"),g.hideLoadingOverlay("loadElementsPresets()")}).error(function(e,o,t,r){console.log(e,o),g.hideLoadingOverlay("loadElementsPresets()")})},h.getSoundCloudTrackID=function(e){g.showLoadingOverlay("getSoundCloudTrackID()");var o=CtBuilderAjax.ajaxUrl,t={action:"oxy_get_soundcloud_track_id",soundcloud_url:e,post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};f({method:"POST",url:h.stripURLProtocol(o),params:t}).success(function(e,o,t,r){e?h.setOptionModel("soundcloud_track_id",e):h.showErrorModal(0,"Error retrieving SoundCloud Track ID. Please check the URL you specified"),g.hideLoadingOverlay()}).error(function(e,o,t,r){console.log(e,o),g.hideLoadingOverlay()})},h.loadConditionsOptions=function(n,e){var o=h.component.active.id,a=iframeScope.component.options[o].model.globalconditions[n].searchValue,t=CtBuilderAjax.ajaxUrl,r={post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce,action:e,search_value:a};jQuery(".oxygen-select-box-options",g.oxygenUIElement).css({opacity:"0.5",pointerEvents:"none"}),f({method:"POST",url:h.stripURLProtocol(t),params:r}).success(function(e,o,t,r){h.updateConditionOptions(n,e,a),jQuery(".oxygen-select-box-options",g.oxygenUIElement).css({opacity:"",pointerEvents:""})}).error(function(e,o,t,r){console.log(e,o),jQuery(".oxygen-select-box-options",g.oxygenUIElement).css({opacity:"",pointerEvents:""})})},h.getAJAXRequestURL=function(){var e=CtBuilderAjax.permalink;return CtBuilderAjax.oxyTemplate&&(e=h.template.postData&&h.template.postData.permalink?h.addTrailingSlash(h.template.postData.permalink):CtBuilderAjax.oxyReusable?h.addTrailingSlash(CtBuilderAjax.ctSiteUrl)+"?post_id="+CtBuilderAjax.postId:CtBuilderAjax.ajaxUrl),e=e.replace("https:","").replace("http:","")},h.stripURLProtocol=function(e){return e.replace("https:","").replace("http:","")},h.addTrailingSlash=function(e){return(e=e.replace(/\/+$/,""))+"/"},h.setPostEditLockTransient=function(e){var o={action:"set_oxygen_edit_post_lock_transient",post_id:CtBuilderAjax.postId,nonce:CtBuilderAjax.nonce};void 0!==e&&!1===e&&(o.action="unset_oxygen_edit_post_lock_transient"),f({method:"POST",url:h.stripURLProtocol(CtBuilderAjax.ajaxUrl),params:o}).error(function(e,o,t,r){console.log(e,o)})},setInterval(function(){h.setPostEditLockTransient()},1e4)}]);
