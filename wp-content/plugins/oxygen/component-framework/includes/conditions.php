...
Class OxygenConditions {
	...
	function register_condition($tag, $values=array('options'=>array()), $operators=array(), $callback, $category = null ) {
...
function register_oxy_conditions() {
    ...
    if ( $pagenow == 'post.php' || !is_admin() || (isset($_GET['action']) && in_array($_GET['action'], $ajax_action_hooks))) {
